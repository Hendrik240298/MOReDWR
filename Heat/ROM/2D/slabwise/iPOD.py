...
def reduce_matrix(matrix, pod_basis_left, pod_basis_right):
    ...
    # pod_basis_left.T.dot(matrix[:n_h_dofs,:n_h_dofs].dot(pod_basis_right))
    reduced_matrix[:n_u_dofs_left, :n_u_dofs_right] = reduction(
        pod_basis_left, matrix[:n_h_dofs, :n_h_dofs], pod_basis_right)
    # pod_basis_left.T.dot(matrix[n_h_dofs:,:n_h_dofs].dot(pod_basis_right))
    reduced_matrix[n_u_dofs_left:, :n_u_dofs_right] = reduction(
        pod_basis_left, matrix[n_h_dofs:, :n_h_dofs], pod_basis_right)
    # pod_basis_left.T.dot(matrix[:n_h_dofs,n_h_dofs:].dot(pod_basis_right))
