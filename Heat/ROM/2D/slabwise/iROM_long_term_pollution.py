...
MOTHER_PATH = "/home/hendrik/Code/MORe_DWR/Heat/"
OUTPUT_PATH = MOTHER_PATH + "Data/2D/rotating_circle_long_term/slabwise/FOM/"
cycle = "cycle=5-0"
SAVE_PATH = MOTHER_PATH + "Data/2D/rotating_circle_long_term/slabwise/ROM/" + cycle + "/"
...
nb_buckets = 128*LONG_TERM_MULTIPLIER
...
plt.plot([0, 10*LONG_TERM_MULTIPLIER], [tol_rel, tol_rel], '--', color='green')
# plt.text(7.25+(LONG_TERM_MULTIPLIER-1)*10, 1.2e-2, "$" + str(tol_rel*100) +
